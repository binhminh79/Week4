from lib.postgresql import etl_helper
...
filename_format = "data2/{table_name}/{{id}}.csv"
# Declare dataset
...
for table_name, schema in table_schemas.items():
    ...
    # etl_helper.extract_postgres_to_gcs(CONNECTION_PARAMS, table_name = table_name, bucket_name=bucket_name,
    ...
    etl_helper.load_data_from_gcs_to_bigquery(
